...
async function handleReview(interaction) {
    ...
    collector.on('collect', async buttonInteraction => {
        ...
        try {
            ...
            logger.error(`[Command Error] /app-admin failed in Guild ${interaction.guildId} by User ${interaction.user.id}: ${error.message}`, { stack: error.stack, errorCode: error.code || 'UNKNOWN' });
