...
export default {
  ...
  async execute(interaction, config, client) {
    try {
      ...
      logger.error(`[Command Error] /wanted failed in Guild ${interaction.guildId} by User ${interaction.user.id}: ${error.message}`, { stack: error.stack, errorCode: error.code || 'UNKNOWN' });
