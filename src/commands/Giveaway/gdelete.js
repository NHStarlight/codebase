...
export default {
    ...
    async execute(interaction) {
        try {
            ...
            logger.error(`[Command Error] /gdelete failed in Guild ${interaction.guildId} by User ${interaction.user.id}: ${error.message}`, { stack: error.stack, errorCode: error.code || 'UNKNOWN' });
