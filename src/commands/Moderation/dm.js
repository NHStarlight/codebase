...
export default {
    ...
    const targetUser = interaction.options.getUser("user");
        ...
        try {
            ...
            logger.error(`[Command Error] /dm failed in Guild ${interaction.guildId} by User ${interaction.user.id}: ${error.message}`, { stack: error.stack, errorCode: error.code || 'UNKNOWN' });
