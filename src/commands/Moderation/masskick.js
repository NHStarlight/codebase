...
.slice(0, 20);
            ...
            for (const userId of userIds) {
                try {
                    ...
                    logger.error(`[Command Error] /masskick failed in Guild ${interaction.guildId} by User ${interaction.user.id}: ${error.message}`, { stack: error.stack, errorCode: error.code || 'UNKNOWN' });
                    results.failed.push({ 
                        userId, 
