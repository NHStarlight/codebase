...
export default {
    ...
    async execute(interaction, guildConfig, client) {
        ...
        try {
            ...
            logger.error(`[Command Error] /serverstats failed in Guild ${interaction.guildId} by User ${interaction.user.id}: ${error.message}`, { stack: error.stack, errorCode: error.code || 'UNKNOWN' });
