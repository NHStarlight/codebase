    ...
    async execute(interaction) {
        ...
        try {
            ...
            try {
                ...
                logger.error(`[Command Error] /baseconvert failed in Guild ${interaction.guildId} by User ${interaction.user.id}: ${error.message}`, { stack: error.stack, errorCode: error.code || 'UNKNOWN' });
