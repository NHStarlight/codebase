    ...
    async execute(interaction) {
        ...
        if (subcommand === 'setup') {
            ...
            try {
                ...
                logger.error(`[Command Error] /welcome failed in Guild ${interaction.guildId} by User ${interaction.user.id}: ${error.message}`, { stack: error.stack, errorCode: error.code || 'UNKNOWN' });
