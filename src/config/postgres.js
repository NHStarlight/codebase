...
export const pgConfig = {
    url: process.env.POSTGRES_URL || process.env.DATABASE_URL || 'postgresql://localhost:5432/nh_starlightsercurity',
    
    options: {
        
        host: process.env.POSTGRES_HOST || process.env.PGHOST || 'localhost',
        port: parseInt(process.env.POSTGRES_PORT || process.env.PGPORT) || 5432,
        database: process.env.POSTGRES_DB || process.env.PGDATABASE || 'nh_starlightsercurity',
        ...
        application_name: 'nh_starlightsercurity',
