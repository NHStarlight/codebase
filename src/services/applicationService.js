...
registerMemoryMap('Application.cooldowns', applicationCooldowns, APPLICATION_SUBMIT_COOLDOWN);
MemoryManager.getInstance().trackMap('Application.cooldowns', applicationCooldowns, { maxSize: 10000, ttlMs: APPLICATION_SUBMIT_COOLDOWN });
