...
registerMemoryMap('Verification.cooldowns', verificationCooldowns, 300000);
registerMemoryMap('Verification.attemptTracker', attemptTracker, 300000);
MemoryManager.getInstance().trackMap('Verification.cooldowns', verificationCooldowns, { maxSize: 10000, ttlMs: 300000 });
MemoryManager.getInstance().trackMap('Verification.attemptTracker', attemptTracker, { maxSize: 10000, ttlMs: 300000 });
